      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
          <div className="p-8 space-y-8">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50 text-left">
                      ...
                      <th className="px-6 py-3 text-gray-500 font-medium sr-only">
                        Actions
                      </th>
                    </tr>
                  </thead>
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <input
                            ...
                            className="w-20 px-3 py-1 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                            min="1"
                          />
                        </td>
            ...
            {/* Add New Product */}
            <div className="space-y-4 bg-blue-50 rounded-xl p-6 border border-blue-100">
              <h3 className="text-lg font-medium text-blue-800">Add Item</h3>
              <div className="flex flex-col sm:flex-row gap-4">
                <select
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                >
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    className="w-20 px-3 py-2 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                    min="1"
                  />
                </div>
                <button
          ...
          <div className="sticky bottom-0 bg-white border-t border-gray-200 p-6 flex justify-end gap-4 shadow-lg">
            <button
              type="button"
              onClick={onClose}
