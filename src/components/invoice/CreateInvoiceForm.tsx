        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6">
            ...
            <p className="text-blue-100 text-sm mt-1">
              {student ? `For: ${student.name}` : "Select a student to continue"}
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-6 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors disabled:bg-blue-300 disabled:cursor-not-allowed"
              >
                Generate Invoice
              </button>
            </div>
            ...
            {student ? (
              <div className="mt-6 bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                <div className="flex justify-between items-center mb-2">
                  <h4 className="font-medium text-blue-800">Selected User</h4>
                  <button
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">{student.admissionNumber}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="mt-6 bg-gray-50 rounded-lg p-6 text-center border border-dashed border-gray-300">
