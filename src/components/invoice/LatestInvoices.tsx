        ...
        {filteredInvoices.map((invoice) => {
          ...
          return (
            ...
            >
              ...
              >
                {expandedInvoices[invoice._id] ? "Hide Details" : "View Details"}
                {expandedInvoices[invoice._id] ? (
                  <ChevronUp className="ml-1 transition-transform duration-300" size={14} />
                ) : (
                  <ChevronDown className="ml-1 transition-transform duration-300" size={14} />
                )}
              </button>
